  ...
  <div class="container">
    <div class="row justify-content-center align-items-center shadow rounded" style="background: #fff; border-radius: 12px; overflow: hidden;">
      ...
      <div class="col-lg-6 p-5">
        <h2 class="text-center mb-3" style="font-weight: 600;">Connexion Propriétaire</h2>
        <p class="text-center text-muted mb-4">Entrez vos informations pour vous connecter</p>

        <form method="POST" action="{{ route('proprietaire.login.submit') }}">
          @csrf
      ...
      <div class="col-lg-6 d-none d-lg-block p-0">
        <img src="{{ asset('assets/images/login2.jpg') }}" alt="Illustration" style="width: 100%; height: 100%; object-fit: cover;">
      </div>
